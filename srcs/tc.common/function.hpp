...
#define TC_FUNCTION_TSP_0
#define TC_FUNCTION_TSP_1 A1
#define TC_FUNCTION_TSP_2 TC_FUNCTION_TSP_1 , A2
#define TC_FUNCTION_TSP_3 TC_FUNCTION_TSP_2 , A3
#define TC_FUNCTION_TSP_4 TC_FUNCTION_TSP_3 , A4
#define TC_FUNCTION_TSP_5 TC_FUNCTION_TSP_4 , A5

// template specialization	
#define TC_FUNCTION_TS_0 R ( TC_FUNCTION_TSP_0 )
#define TC_FUNCTION_TS_1 R ( TC_FUNCTION_TSP_1 )
#define TC_FUNCTION_TS_2 R ( TC_FUNCTION_TSP_2 )
#define TC_FUNCTION_TS_3 R ( TC_FUNCTION_TSP_3 )
#define TC_FUNCTION_TS_4 R ( TC_FUNCTION_TSP_4 )
#define TC_FUNCTION_TS_5 R ( TC_FUNCTION_TSP_5 )
...
#define TC_FUNCTION_TP_5 TC_FUNCTION_TP_4 , typename forward_traits< A5 >::type p5
...
#define TC_FUNCTION_TF_5 TC_FUNCTION_TF_4 , p5

#define TC_FUNCTION_TP2_0 void* ctx
#define TC_FUNCTION_TP2_1 TC_FUNCTION_TP2_0 , typename forward_traits< A1 >::type p1 
#define TC_FUNCTION_TP2_2 TC_FUNCTION_TP2_1 , typename forward_traits< A2 >::type p2
#define TC_FUNCTION_TP2_3 TC_FUNCTION_TP2_2 , typename forward_traits< A3 >::type p3
#define TC_FUNCTION_TP2_4 TC_FUNCTION_TP2_3 , typename forward_traits< A4 >::type p4
#define TC_FUNCTION_TP2_5 TC_FUNCTION_TP2_4 , typename forward_traits< A5 >::type p5

#define TC_FUNCTION_TF2_0 _context
#define TC_FUNCTION_TF2_1 TC_FUNCTION_TF2_0 , p1
#define TC_FUNCTION_TF2_2 TC_FUNCTION_TF2_1 , p2
#define TC_FUNCTION_TF2_3 TC_FUNCTION_TF2_2 , p3
#define TC_FUNCTION_TF2_4 TC_FUNCTION_TF2_3 , p4
#define TC_FUNCTION_TF2_5 TC_FUNCTION_TF2_4 , p5
...
#define TC_FUNCTION_DECLARE_FUNCTION( TD , TS , TP , TF , TP2 , TF2 )\
template < TD >\
class function< TS > {\
...
#define TC_FUNCTION_DECLARE_FUNCTION_PARAM_N( n ) \
		TC_FUNCTION_DECLARE_FUNCTION( \
		TC_FUNCTION_TD_##n , \
		TC_FUNCTION_TS_##n , \
		TC_FUNCTION_TP_##n , \
		TC_FUNCTION_TF_##n , \
...
TC_FUNCTION_DECLARE_FUNCTION_PARAM_N(0)
TC_FUNCTION_DECLARE_FUNCTION_PARAM_N(1)
TC_FUNCTION_DECLARE_FUNCTION_PARAM_N(2)
TC_FUNCTION_DECLARE_FUNCTION_PARAM_N(3)
TC_FUNCTION_DECLARE_FUNCTION_PARAM_N(4)
TC_FUNCTION_DECLARE_FUNCTION_PARAM_N(5)
